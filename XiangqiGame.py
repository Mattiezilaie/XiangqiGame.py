...
#print(game.make_move('i10', 'i9')) # check to see if black side can move twice in a row = F

#print(game.make_move('c10', 'e8')) # check to see if black side can go first = F

# checks general- move out of palace, and if team moves twice in a row
#print(game.make_move('e1', 'e2')) # Red general moves one space forward - T
#print(game.make_move('e10', 'e9')) # black general moves one space forward - T
#print(game.make_move('e2', 'd2')) # red general moves right - T
#print(game.make_move('e9', 'f9')) # black general moves left - T
#print(game.make_move('d2', 'd3')) # red moves to corner of palace - T
#print(game.make_move('d3', 'd4')) # red moves twice and out of palace - F
#print(game.make_move('d3', 'd2')) # red general moves backward one space- T
#print(game.make_move('f9', 'e9')) # black general moves out of palace - F
#print(game.make_move('e9', 'f9')) # balck general moves twice - F

#advisor- check to see only allowed to move diagonal, and must stay in palace(5 points)
#print(game.make_move('f1', 'e2')) # red advisor moves diagonal
#print(game.make_move('f10', 'e9')) # Black advisor moves diagonal
#print(game.make_move('e2', 'e3')) # red advisor tries to move straight - F
#print(game.make_move('e2', 'd3')) # red advisor moves diagnoal - T
#print(game.make_move('e9', 'd8'))# black advisor moves diagonal - T
#print(game.make_move('c4', 'c5')) # red cannon moves one space forward - T
#print(game.make_move('d8', 'e9')) # black advisor can move backwards- T
#print(game.make_move('d3', 'c4'))# red advisor moves out of palace - F

# Elephant- moves 2 points diagonal only/backwards, no jumping over pieces, & cannot cross river


# Horse - moves 1 point L,R, Forward/backwards, diagonal. Cannot jump pieces.
# Can be blocked piece one point horizontal/vertical


# Chariot - moves any distance forward, R, L, backwards. Cannot jump


# Cannon - moves any distance, R/L forward/back.cannot jump. only captures by jumping single piece, red/black team's
#print(game.make_move('h3', 'h7'))
#print(game.make_move('i10', 'i9'))
#print(game.make_move('h7', 'h10'))

# soldiers - move/capture advancing one point. Once cross river can move horizontal too. cannot move backwards.
# Once at enemies last rank can move L/R
#print(game.make_move('a4', 'a3')) # check if can move backwards - F
